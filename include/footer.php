<div class="footer-fixed hide-on-med-and-up">
  <footer class="red lighten-2">
    <?php
     require dirname(__FILE__).'/navbar_mobile.php'; 
     ?>
  </footer>
</div>
</body>
...
<script type="text/javascript">
  ...
  console.log('%cBe Aware!', 'color: red; font-size: 30px; font-weight: bold;');
    let BASE_URL = "<?php echo API_URL; ?>";
    let mUserName = "<?php echo $mUser->name; ?>";
    let mUserUsername = "<?php echo $mUser->username; ?>";
    let mUserImage = "<?php echo $mUser->image; ?>";
...
function changePassword()
{
  ...
  if(confirmPassword.length<8)
  {
    Toast.fire({
      icon: 'error',
      title: 'Confirm Password is too short'
    })
    return;
  }
